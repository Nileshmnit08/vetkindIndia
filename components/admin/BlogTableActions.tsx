...
import { toggleBlogArticleStatus, deleteBlogArticle } from "@/app/actions/blog";
...
export function BlogTableActions({ id, status, title }: BlogTableActionsProps) {
  ...
  const handleToggleStatus = async () => {
    setIsUpdating(true);
    await toggleBlogArticleStatus(id, status);
    setIsUpdating(false);
    setIsOpen(false);
  };
