...
import { createNewsEvent, updateNewsEvent } from "@/app/actions/news-events";
...
export function NewsEventForm({ initialData }: NewsEventFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    let result;
    if (initialData?.id) {
      result = await updateNewsEvent(initialData.id, data);
    } else {
      result = await createNewsEvent(data);
    }
      ...
      <div className="space-y-8 divide-y divide-zinc-200 dark:divide-zinc-800 sm:space-y-5">
        <div className="space-y-6 sm:space-y-5">
          <div>
            ...
            <p className="mt-1 max-w-2xl text-sm text-zinc-500 dark:text-zinc-400">
              Set up the content for this item.
            </p>
          </div>
          ...
          <div className="space-y-6 sm:space-y-5">
            ...
            <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
              <label htmlFor="type" className="block text-sm font-medium leading-6 text-zinc-900 dark:text-zinc-300 sm:pt-1.5">
                Type
              </label>
              <div className="mt-2 sm:col-span-2 sm:mt-0">
                <select
            ...
            <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
              <label htmlFor="summary" className="block text-sm font-medium leading-6 text-zinc-900 dark:text-zinc-300 sm:pt-1.5">
                Summary
              </label>
              <div className="mt-2 sm:col-span-2 sm:mt-0">
                <textarea
            ...
            <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
              <label htmlFor="content" className="block text-sm font-medium leading-6 text-zinc-900 dark:text-zinc-300 sm:pt-1.5">
                Content
              </label>
              <div className="mt-2 sm:col-span-2 sm:mt-0">
                <textarea
        ...
        <div className="pt-8 sm:pt-10">
          ...
          <div className="space-y-6 sm:space-y-5 mt-6">
            ...
            <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
              <label htmlFor="eventDate" className="block text-sm font-medium leading-6 text-zinc-900 dark:text-zinc-300 sm:pt-1.5">
                Event Date (Optional)
              </label>
              <div className="mt-2 sm:col-span-2 sm:mt-0">
                <input
            ...
            <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
              <label htmlFor="location" className="block text-sm font-medium leading-6 text-zinc-900 dark:text-zinc-300 sm:pt-1.5">
                Location (Optional)
              </label>
              <div className="mt-2 sm:col-span-2 sm:mt-0">
                <input
