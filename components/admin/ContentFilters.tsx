...
export function ContentFilters({ basePath, filterParamName, filterOptions, filterLabel }: ContentFiltersProps) {
  ...
  const handleFilterChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    updateParams({ [filterParamName]: e.target.value || null, page: "1" });
  };
      ...
      {filterOptions.length > 0 && (
        <div className="w-full sm:w-48">
          <select
            ...
            defaultValue={searchParams.get(filterParamName) || ""}
