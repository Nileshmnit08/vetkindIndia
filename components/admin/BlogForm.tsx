...
import { createBlogArticle, updateBlogArticle } from "@/app/actions/blog";
...
export function BlogForm({ initialData }: BlogFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    let result;
    if (initialData?.id) {
      result = await updateBlogArticle(initialData.id, data);
    } else {
      ...
      <div className="space-y-8 divide-y divide-zinc-200 dark:divide-zinc-800 sm:space-y-5">
        <div className="space-y-6 sm:space-y-5">
          <div>
            ...
            <p className="mt-1 max-w-2xl text-sm text-zinc-500 dark:text-zinc-400">
              Set up the content for this blog article.
            </p>
          </div>
        ...
        <div className="pt-8 sm:pt-10">
          ...
          <div className="space-y-6 sm:space-y-5 mt-6">
            ...
            <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
              <label htmlFor="tags" className="block text-sm font-medium leading-6 text-zinc-900 dark:text-zinc-300 sm:pt-1.5">
                Tags
              </label>
              <div className="mt-2 sm:col-span-2 sm:mt-0">
                <input
                  ...
                  name="tags"
                  id="tags"
                  placeholder="e.g. calves, nutrition, hygiene"
