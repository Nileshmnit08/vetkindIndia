...
export function FloatingCustomerCare() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center rounded-full bg-[#25D366] p-4 text-white shadow-xl shadow-[#25D366]/30 transition-all duration-300 hover:scale-110 hover:shadow-[#25D366]/50 focus:outline-none focus:ring-2 focus:ring-[#25D366] focus:ring-offset-2"
    ...
    >
      ...
      <span
        className={`overflow-hidden whitespace-nowrap font-medium transition-all duration-300 ${
          isHovered ? "ml-2 max-w-[120px] opacity-100" : "ml-0 max-w-0 opacity-0"
        }`}
      >
        Talk to Us
      </span>
