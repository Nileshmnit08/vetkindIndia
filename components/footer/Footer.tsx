        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-5 border-b border-zinc-900 pb-16 mb-8">
          <div className="lg:col-span-2 space-y-8 pr-0 lg:pr-12">
            ...
            <div className="flex gap-5">
              <a href={companyConfig.socials.facebook} target="_blank" rel="noreferrer" className="text-zinc-500 hover:text-green-500 transition-colors" aria-label="Facebook">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
              </a>
              <a href={companyConfig.socials.twitter} target="_blank" rel="noreferrer" className="text-zinc-500 hover:text-green-500 transition-colors" aria-label="Twitter">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"/></svg>
              </a>
              <a href={companyConfig.socials.instagram} target="_blank" rel="noreferrer" className="text-zinc-500 hover:text-green-500 transition-colors" aria-label="Instagram">
              ...
              <a href={companyConfig.socials.linkedin} target="_blank" rel="noreferrer" className="text-zinc-500 hover:text-green-500 transition-colors" aria-label="LinkedIn">
          ...
          <div>
            ...
            <ul className="space-y-5 text-base text-zinc-400">
              <li className="flex items-center gap-3"><Phone className="h-5 w-5 shrink-0 text-green-500" /> {companyConfig.contact.phone}</li>
              <li className="flex items-center gap-3"><Mail className="h-5 w-5 shrink-0 text-green-500" /> {companyConfig.contact.email}</li>
              <li className="flex items-start gap-3"><MapPin className="h-5 w-5 shrink-0 mt-0.5 text-green-500" /> {companyConfig.contact.address.city}, {companyConfig.contact.address.state}, {companyConfig.contact.address.country}</li>
            </ul>
          </div>
        </div>
